...
function draw() {
  ...
  if(gameState === "start0"){
    ...
    text("She eventually gets curious about her true identity as it is not normal.", 0 ,200);
    text("So she sets on an adventure to find her true identity." , 0, 400);

    fill("red");
    text("Press Arrow keys to move the girl", 0, 550);
...
bird.visible= false;
  ...
  fill("red");
  text("Ivy transforms each time your score is in the multiple of 100." , 0, 100);
